#Sweet scoop ice cream parlour expanded
import streamlit as st

st.set_page_config(page_title="Sweet Scoop Ice cream",page_icon="🍨",layout="centered",
                   initial_sidebar_state="collapsed",
                   menu_items={'Get Help' : 'https://example.com/help','About':'Made by kids'})
...
#Add toppings
toppings = st.multiselect("Add toppings", ["Nuts","Cherry","Caramel","Sprinkles"])
...
with col2:
  st.markdown(f"### Flavors: {flavor_preview}")
  st.markdown(f"### Toppings: {topping_preview}")  
